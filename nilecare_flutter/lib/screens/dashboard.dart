...
import '../services/onboarding_service.dart'; // Import your service
...
class _DashboardPageState extends State<DashboardPage>
  ...
  Future<void> _fetchProfile() async {
    try {
      final profile = await _onboardingService.getDoctorProfile(
        userId: "demo-user-1", // Replace with actual logged-in user ID
      );
      setState(() {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${AppLocalizations.of(context)!.greeting}, ${doctorProfile?['name'] ?? "Doctor"} 👋',
  ...
  /// Next Appointment Card (uses doctorProfile)
              ...
              children: [
                Text(AppLocalizations.of(context)!.nextAppointment,
                    style: GoogleFonts.poppins(
                        ...
                        color: textColor)),
                const SizedBox(height: 8),
                Text(doctorProfile?['specialization'] ?? "General Checkup",
  ...
  /// Replace later with API-driven history
  Widget _historyList(BuildContext context) {
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          _buildHistoryCard(
              context, "July 20", "Dr. ${doctorProfile?['name'] ?? "Unknown"}",
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('${doctorProfile?['wellnessScore'] ?? 80} / 100',
                      style: GoogleFonts.poppins(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Colors.green)),
